...
public class RunsDataInput {
    ...
    private String Aerobic_TE;
    private String Avg_Run_Cadence;
    private String Max_Run_Cadence;
    private String Avg_Pace;
    private String Best_Pace;
    private String Total_Ascent;
    private String Total_Descent;
    ...
    private String AvgSwolf;
    private String Avg_Stroke_Rate;
